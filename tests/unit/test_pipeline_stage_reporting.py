...
def test_lint_gate_exists_and_holds_undefined_names_at_zero():
    ...
    assert "F821" not in baseline, (
        "F821 was moved into the ratchet baseline. It is enforced at zero; putting "
        "it in the baseline makes new undefined names landable again."
    )
