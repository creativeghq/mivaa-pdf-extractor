...
class SLIGEndpointManager:
    ...
    def scale_to_zero(self) -> bool:
        ...
        try:
            ...
            logger.info(f"📉 Scaling SLIG endpoint to 0 replicas (JOB COMPLETED - will auto-resume on demand)")
            ...
            self.warmup_completed = False
            logger.info(f"✅ SLIG endpoint scaled to 0 (was: {current_status}, max: {max_rep})")
            return True
