...
REQUIRED_PROMPTS: Tuple[Tuple[str, str, Optional[str]], ...] = (
    ...
    ("extraction", "marketplace_bestprice_search", "price_monitoring"),
    ("extraction", "marketplace_bestprice_product_page", "price_monitoring"),
    ("extraction", "marketplace_skroutz_search", "price_monitoring"),
    ("extraction", "marketplace_skroutz_product_page", "price_monitoring"),
    ("extraction", "marketplace_shopflix_search", "price_monitoring"),
    ("extraction", "marketplace_idealo_search", "price_monitoring"),
    ("extraction", "price_verification_page", "price_monitoring"),
    ("extraction", "price_search_system", "price_monitoring"),
    ("extraction", "price_search_user", "price_monitoring"),
    ("classification", "llm_mention_probe", "mention_monitoring"),
    ("extraction", "inpaint_prompt_writer", "image_analysis"),
    ("extraction", "job_board_domains", "job_research"),
    ("extraction", "job_page_all", "job_research"),
    ("extraction", "job_page_recent", "job_research"),
    ("extraction", "job_posting_search", "job_research"),
    ("extraction", "opportunity_polish", "mention_monitoring"),
    ("extraction", "product_cross_reference", "entity_creation"),
    ("extraction", "product_custom_match", "entity_creation"),
    ("extraction", "product_description_writer", "entity_creation"),
    ("extraction", "search_query_enhancement", "search"),
    ("extraction", "search_query_expansion", "search"),
    ("extraction", "search_result_enrichment", "search"),
    ("extraction", "search_result_filtering", "search"),
    ("extraction", "search_result_formatting", "search"),
    ("extraction", "product_deep_analysis", "entity_creation"),
    ("extraction", "rag_advanced_answer", "rag"),
    ("extraction", "rag_document_answer", "rag"),
