...
class PerplexityPriceSearchService:
    ...
    def _build_messages(
        ...
        system_prompt = (
            ...
            "- Include out-of-stock listings when a price is shown on the page (out-of-stock posted "
            "  prices are valid market data). Record availability accurately.\n"
            "- EXCLUDE quote-only / 'contact for price' / hidden-behind-login entries. Do NOT fabricate "
            "  prices to fill the list.\n"
