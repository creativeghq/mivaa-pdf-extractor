...
# The duplicate /search/knowledge-base route that used to live at the end of this
# file was removed (issue #318). It was an older copy of the same path served by
# app/api/rag_routes.py, and Starlette answers with whichever router main.py
# included FIRST — rag_router at line ~1986, this one at ~1989. So it was dead by
# three lines of registration order, and reordering them would have silently
# swapped working retrieval for its substring scorer. Its KnowledgeBaseSearch*
# models went with it; they had no other caller.
