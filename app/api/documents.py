...
# ============================================================================
# The following endpoints have been removed and consolidated into /api/rag/documents/upload:
# - POST /process - Use /api/rag/documents/upload with processing_mode="quick"
# - POST /process-url - Use /api/rag/documents/upload with file_url parameter
# ============================================================================
# ============================================================================
# REMOVED TEST ENDPOINTS
# ============================================================================
# The following test endpoints have been removed:
# - POST /test-batch
# - POST /new-batch-process
# - POST /batch-process-fixed
# - POST /batch-process-test
# ============================================================================
