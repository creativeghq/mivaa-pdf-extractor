...
async def process_single_document(url: str, options: Any, pdf_processor: PDFProcessor, job_id: str = None):
    ...
    try:
        ...
        progress_callback(40.0, "PDF processing completed, analyzing content")
        ...
        if result.markdown_content:
            try:
                ...
                progress_callback(60.0, "Creating text chunks for RAG pipeline")
                ...
                progress_callback(70.0, "Preparing for RAG indexing with embeddings")
        ...
        try:
            ...
            progress_callback(85.0, "Uploading document to RAG system for search indexing")
